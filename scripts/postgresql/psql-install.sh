...
# Section 8 - setupDB.sql script is ran

echo "Wait for PostgreSQL to finish starting up..."
sleep 5

# The setupDB.sql script is ran to create the user, database, and populate the database.
echo "Running script"
$rfolder/bin/psql -U postgres -f $setupscript
